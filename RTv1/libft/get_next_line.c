...
static int			ft_line_fill(char **lst, char **line, int chr)
{
	char			*point;
...
static char			*ft_strjoin_free(char *lst, char *buf)
{
	char			*point;
...
static t_list		*ft_lstcheck(int fd, t_list **point)
{
	t_list			*tmp;
